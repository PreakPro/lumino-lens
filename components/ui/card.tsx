...
export default function Card({ className, children, svgPath, delay, direction }: cardInterface) {
    return (
        <motion.div 
            className={cn("bg-[#FFB76E] flex flex-col h-80 w-80 justify-center items-center gap-4 text-4xl rounded-lg shadow-neutral-600 shadow-sm border-black border-1 z-5", className)}
